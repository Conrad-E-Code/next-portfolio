  ...
  return (
    <li onClick={(e)=>{
      router.push(`/blog/${blogId}`)}} className={"relative"} style={{
        ...
        <a  className={ `flex py-3 px-3 items-center gap-3 relative rounded-md hover:bg-[#2A2B32] cursor-pointer break-all hover:pr-4 bg-gray-900 group ${path === `/blog/${blogId}` ? "bg-[#343541]/70" : null }`}>
